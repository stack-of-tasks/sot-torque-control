...
def create_butter_lp_filter_Wn_05_N_3(name, dt, size):
    ...
    # delay about 13*dt
    lp_filter.init(dt, size, (0.00041655, 0.00124964, 0.00124964, 0.00041655),
...
def create_butter_lp_filter_Wn_03_N_3(name, dt, size):
    ...
    # delay about 20*dt
    lp_filter.init(dt, size, (9.54425084e-05, 2.86327525e-04, 2.86327525e-04, 9.54425084e-05),
                   (1., -2.81157368, 2.64048349, -0.82814628))
    return lp_filter

...
def create_butter_lp_filter_Wn_05_N_2(name, dt, size):
    ...
    # delay about 9*dt
    lp_filter.init(dt, size, 3, 3, (0.00554272,  0.01108543,  0.00554272), (1., -1.77863178,  0.80080265));
    return lp_filter;
...
def create_butter_lp_filter_Wn_05_N_3(name, dt, size):
    ...
    # delay about 13*dt
    lp_filter.init(dt, size, 4, 4, (0.00041655,  0.00124964,  0.00124964,  0.00041655), (1., -2.6861574 ,  2.41965511, -0.73016535));
    return lp_filter;
...
def create_butter_lp_filter_Wn_05_N_4(name, dt, size):
    ...
    # delay about 16*dt
    lp_filter.init(dt, size, 5, 5, (3.12389769e-05,   1.24955908e-04,   1.87433862e-04, 1.24955908e-04,   3.12389769e-05), 
...
def create_butter_lp_filter_Wn_03_N_3(name, dt, size):
    ...
    # delay about 20*dt
    lp_filter.init(dt, size, 4, 4, (9.54425084e-05,   2.86327525e-04,   2.86327525e-04, 9.54425084e-05), (1., -2.81157368,  2.64048349, -0.82814628));
    return lp_filter;
...
def create_butter_lp_filter_Wn_03_N_4(name, dt, size):
    ...
    # delay about 28*dt
    lp_filter.init(dt, size, 5, 5, (4.37268880e-06,   1.74907552e-05,   2.62361328e-05, 1.74907552e-05,   4.37268880e-06), 
...
def create_chebi2_lp_filter_Wn_03_N_4(name, dt, size):
    ...
    # delay about 23*dt
    lp_filter.init(dt, size, 5, 5, (0.09147425, -0.35947268,  0.53605377, -0.35947268,  0.09147425), 

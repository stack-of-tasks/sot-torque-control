...
def replug_estimator_kin(robot, estimator_fd):
    ...
    robot.estimator_ft.ddq_filtered.value = (0.0,) * 30
    plug(estimator_fd.dx, robot.torque_ctrl.jointsVelocities)
    robot.torque_ctrl.jointsAccelerations.value = (0.0,) * 30
...
def conf_filter_list():
    ...
    conf.a_list = [
        np.array([1.0, -1.72610371, 0.76236003]),
        np.array([1.0, -1.73969005, 0.7613755]),
        np.array([1.0, -1.78994555, 0.80417199]),
        np.array([1.0, -1.86689228, 0.87521455]),
        np.array([1.0, -0.93906251]),
        np.array([1.0, -1.84107589, 0.84928308]),
        np.array([1.0, -1.91119707, 0.91497583]),
        np.array([1.0, -2.85434518, 2.721757, -0.86687514]),
        np.array([1.0, -2.8543607, 2.72178648, -0.86688893]),
        np.array([1.0, -2.77503623, 2.57077857, -0.79499342]),
        np.array([1.0, -1.89310959, 0.8968526]),
        np.array(
            [
                1.0,
                -5.30603285,
        ...
        np.array([1.0, -3.70990618, 5.16705461, -3.20193343, 0.74485337]),
        np.array([1.0, -4.80072628, 9.23289417, -8.89170853, 4.28778797, -0.82824331]),
        np.array([1.0, -4.64518256, 8.63880318, -8.0399445, 3.74448588, -0.69815575]),
        np.array(
            [
                1.0,
                -7.27133134,

...
if (PLOT_3D_SURFACE):
    ...
    plot3d(dq,
           tau,
           ctrl,
           'Symmetric ID with Coloumb friction- ' + data_folder[-10:], ['dq', 'tau', 'delta q'],
           'r ',
           ax=ax)
    ax.plot_wireframe(X, Y, Z)
...
if PLOT_LOW_VEL_DATA_3D:
    ...
    plot3d(dq_zero_vel,
           tau_zero_vel,
           ctrl_zero_vel,
           'Low velocity data asymmetric penalty ' + data_folder[-10:], ['dq', 'tau', 'delta q'],
           'r ',
           ax=ax)
    ax.plot_wireframe(X, Y, Z)
    ax = fig.add_subplot(222, projection='3d')
    ...
    plot3d(dq_zero_vel,
           tau_zero_vel,
           ctrl_zero_vel,
           'Low velocity data symmetric penalty ' + data_folder[-10:], ['dq', 'tau', 'delta q'],
           'r ',
           ax=ax)
    ax.plot_wireframe(X, Y, Z)
    ax = fig.add_subplot(223, projection='3d')
    ...
    plot3d(dq_zero_vel,
           tau_zero_vel,
           ctrl_zero_vel,
           'Low velocity data Coloumb ' + data_folder[-10:], ['dq', 'tau', 'delta q'],
           'r ',
           ax=ax)
    ax.plot_wireframe(X, Y, Z)

...
def load_hrpsys_log_astate(astate_path, angle_unit='deg'):
    ...
    dt = 'f4'
    a = np.zeros(m,
                 dtype=[('enc', dt, 40), ('torque', dt, 40), ('ss', dt, 40), ('forceRL', dt, 6), ('forceLL', dt, 6),
                        ('forceRA', dt, 6), ('forceLA', dt, 6), ('acc', dt, 6), ('gyro', dt, 3), ('qrot', dt, 9),
                        ('waist_p', dt, 3), ('waist_rot', dt, 9), ('time', dt, 1), ('controltimev2', dt, 1),
                        ('type', 'a6'), ('ang_type', 'a3')])
    a['enc'] = astate[:, 0:40]
    # JA0-JA39
...
def load_hrpsys_log_rstate(rstate_path, angle_unit='deg'):
    ...
    dt = 'f4'
    r = np.zeros(m,
                 dtype=[('enc', dt, 40), ('jvelocity', dt, 40), ('acc', dt, 3), ('zmp', dt, 3), ('waist_p', dt, 3),
                        ('waist_rot', dt, 9), ('time', dt, 1), ('controltimev2', dt, 1), ('type', 'a6'),
                        ('ang_type', 'a3')])
    r['enc'] = rstate[:, 0:40]
    # JA0-JA39

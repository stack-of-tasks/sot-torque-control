...
try:
    ...
    np.savez(data_folder+DATA_FILE_NAME, f=f,fRef=fRef, dq=dq, tau=tau, tauDes=tauDes, qDes=qDes, enc=enc, qRef=qRef,
...
#    plt.figure(); plt.plot(tau[:,i]); plt.plot(tauDes[:,i],'r--'); plt.title('Joint '+str(JOINT_ID[i])+' tau VS tauDes');

 ...
 * To do...
 */
class SOTJOINTTORQUECONTROLLER_EXPORT JointTorqueController : public ::dynamicgraph::Entity {
 ...
 public:                                                             /* --- SIGNALS --- */
  ...
  //        DECLARE_SIGNAL_IN(jointsTorquesDesiredDerivative, dynamicgraph::Vector);/// desired joints torques
  //        derivative dtauDes
